...
const changeclrbtn = document.getElementById('main-colorbtn');
...
function maincolorset() {
  ...
  window.localStorage.setItem('color-theme', maincolore);
  var currentTheme = localStorage.getItem('color-theme');
  document.documentElement.style.setProperty('--main-color', currentTheme );
}
